...
public class DataBase {
    ...
    private void addElements() {
        ...
        elements.put("Zasada \"CiuL\"", new DictionaryElement("Zasada \"CiuL\"", "Jest to łatwy sposób na zapamiętanie przesunięć fazowych dla cewek i kondensatorów. Patrząc od lewej na kondensatorze (C) prąd (\"i\") wyprzedza napięcie (\"u\"). A patrząc od lewej na cewce (L) to napięcie (\"u\") wyprzedza prąd (\"i\").", R.drawable.ciul));
